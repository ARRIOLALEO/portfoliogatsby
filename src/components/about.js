                ...
                <div class="items-center lg:flex">
                    <div class="lg:w-2/3">
                        ...
                        <p class="mt-3 text-base text-gray-500 sm:mt-5 text-justify">
                            ...
                            товары, услуги, свои разработки и изделия собственного производства.
                            Впрочем, чем бы вы ни занимались, вам потребуется эффективный инструмент
                            по продвижению своего бизнеса в интернете, ведь именно на его просторах
                            находится основная часть потребителей. Их нужно завоевать, а значит
                            заинтересовать своими проектами. В этой схватке вам придется побороться
                            и с вашими конкурентами, которые раньше вас вышли в
                            интернет-пространство. Поддержку в решении этих вопросов вам обеспечит
                            команда специалистов, которая более 4 лет занимается разработкой и
                            продвижением продающих сайтов с индивидуальным стилем.
                        </p>
